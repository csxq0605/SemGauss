...
def transformed_params2rendervar(params, w2c, transformed_pts):
    depth = get_depth_and_silhouette(transformed_pts, w2c)
    precomp = torch.cat((params['rgb_colors'], depth), dim=1)
    rendervar = {
        'means3D': transformed_pts,
        'colors_precomp': precomp,
        'sh_sems': params['sem_labels'],
...
def get_depth_and_silhouette(pts_3D, w2c):
    ...
    """
    depth_z = pts_3D[:, 2].unsqueeze(-1)  # [num_gaussians, 1]
